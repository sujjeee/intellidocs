...
const NewsLetter = () => {
    return (
        <section>
            <div >
                <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:py-32 lg:px-4 lg:flex lg:items-center">
                    <div className="lg:w-0 lg:flex-1">
                        <h2 className="text-xl font-bold text-gray-900">Sign up for our newsletter</h2>
                        <p className="mt-3 max-w-3xl text-base lg:max-w-md text-gray-500">
